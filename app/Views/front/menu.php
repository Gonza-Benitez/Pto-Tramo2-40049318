...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/Tramo2_40049318/assets/css/bootstrap.min.css">
    <link rel="stylesheet" href="http://localhost/Tramo2_40049318/assets/misestilos.css">
    <link rel="icon" href="http://localhost/Tramo2_40049318/assets/img/iconos/tabaquera.png">
</head>
<body>
    <header>
      <nav class="navbar navbar-expand-md custom-bg-color">
        <div class="container-fluid">
          <a class="navbar-brand" href="<?php echo base_url('front/principal')?>">
            <img src="../assets/img/iconos/tabaquera.png" alt="Logo TabaqueriaCtes" width="45" height="45" class="d-inline-block align-text-top">
          </a>
          <a class="navbar-brand" href="<?php echo base_url('front/principal')?>">
